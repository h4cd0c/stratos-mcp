...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  try {
    switch (request.params.name) {
      case "help": {
        const helpText = `# Azure Penetration Testing MCP Server - Help Guide

## Overview
This MCP server provides 25 comprehensive tools for Azure security assessment and penetration testing. All tools use your current Azure CLI credentials (az login).
...
`;
      ...
      case "generate_security_report": {
        ...
        report += `---\n\n`;
        report += `*Generated by Azure Penetration Testing MCP Server v1.6.0*\n`;
...
<body>
  <div class="container">
    ...
    <hr>
    <p class="metadata">Generated by Azure Penetration Testing MCP Server v1.6.0</p>
  </div>
</body>
</html>`;
        ...
        if (outputFormat === "pdf") {
          ...
          try {
            ...
            doc.fontSize(8).fillColor('#666')
              .text('Generated by Azure Penetration Testing MCP Server v1.6.0', { align: 'center' });
      ...
      case "analyze_attack_paths": {
        ...
        report += `*Generated by Azure Penetration Testing MCP Server v1.4.0*\n`;
